...
<!-- canonical: https://adrianaspmu.com/aftercare/ -->
> Day-by-day PMU healing timeline, dry vs. moist healing, what to avoid, and contraindications for brows, lips, and eyeliner in Wilmington MA and Salem NH.
...
Written by Adriana Souza Santos, Master Permanent Makeup Artist. Cross-checked against AAD guidance. Last reviewed September 10, 2026 — educational content, not medical advice.
...
Brows, lips, and eyeliner heal on roughly the same calendar, though steps differ by area (see below). Every client leaves with written instructions and the [contact page](../contact/) for healing questions — signs of infection need a doctor instead.
...
Anyone with a history of cold sores (HSV-1) should raise it with a doctor before booking a [lip blush](../services/lips/lip-blush/) appointment, not after — needle trauma can trigger an outbreak even years later. Some clinicians prescribe a preventive antiviral before and after the session.
